...
\cvline{Langues}{
 \definecolor{old-glory-red}{rgb}{.698,.132,.203}
 \definecolor{old-glory-blue}{rgb}{.234,.233,.43}
 \tikzset{star/.pic={\fill[white](90:2/65)--(234:2/65)--(18:2/65)--(162:2/65)--(306:2/65);}}
 \tikz[x=7,y=7] {
   \foreach\y in{0,1,2,3,4,5,6} {
     \fill[fill=old-glory-red](0,\y*2/13)rectangle+(1.9,1/13);
   }
   \fill[fill=old-glory-blue](0,6/13)rectangle(0.76,1);
   \foreach\x in{1,3,5,7,9,11}{
     \foreach\y in{1,3,5,7,9}{
       \draw(\x*1.9/30,6/13+\y*7/130)pic{star};
     }
   }
   ...
   \draw[ultra thin]rectangle(1.9,1);
 }
 Américain courant,
%
 \definecolor{eo-green}{rgb}{0,.6,0}
 \tikz[x=7,y=7] {
   \fill[fill=eo-green]rectangle(1.5,1);
   \fill[fill=white](0,.5)rectangle(.5,1);
   \fill[fill=eo-green](.25,.75) --
   +(90:.175) -- +(234:.175) -- +(18:.175) -- +(162:.175) -- +(306:.175);
   \draw[ultra thin]rectangle(1.5,1);
 }
 Espéranto débutant
}
